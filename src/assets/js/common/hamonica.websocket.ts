//@ts-nocheck
import { defineProto, portobufInit } from '@/protobuf/define/proto';
...
class WebSocketClient {
    ...
    #init = () => {
        ...
        this.#instance.onmessage = (e, flags)=>{
            ...
            //protobuf 불러오기.
            var Command = defineProto.Command;
            let responseData = null;

            try {
                
                responseData = Command.decode(new Uint8Array(e.data));
            ...
            if(responseData.error === true){
                ...
                this.onmessage(e, responseData, createCommand(responseData), flags);
            }
