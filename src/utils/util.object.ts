...
const object = {
     ...
     * @since 2021.04.01
     */
    isChanged: (originalObject:any, newObject:any) => {
     ...
     * @return [{}] 배열 json 데이터
     */
    convertDataToCombo: (data:any[], idKey:string, nameKey:string):any[] => {
